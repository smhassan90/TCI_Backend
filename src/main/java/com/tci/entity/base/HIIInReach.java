...
public class HIIInReach {
    ...
    @Column(name="inReachFilename")
    private String inReachFilename;
    ...
    public String getInReachFilename() {
        return inReachFilename;
    }

    public void setInReachFilename(String inReachFilename) {
        this.inReachFilename = inReachFilename;
    }
